defmodule JessicaWeb.CoreComponents do
  @moduledoc """
  ...
  def show_mobile_sidebar(js \\ %JS{}) do
    ...
    |> JS.show(
      ...
      time: 300,
      transition:
        {"transition ease-in-out duration-600 transform", "translate-x-full", "translate-x-0"}
    )
  ...
  def hide_mobile_sidebar(js \\ %JS{}) do
    ...
    |> JS.hide(
      ...
      time: 300,
      transition:
        {"transition ease-in-out duration-600 transform", "translate-x-0", "translate-x-full"}
    )
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JessicaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JessicaWeb.Gettext, "errors", msg, opts)
    end
  end
